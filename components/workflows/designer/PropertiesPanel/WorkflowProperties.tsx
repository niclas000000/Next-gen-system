...
export function WorkflowProperties() {
  const { workflowName, workflowDescription, nodes, edges, updateWorkflowMeta } = useWorkflowDesignerStore()
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="pt-2 border-t border-slate-100 space-y-1">
        ...
        <p className="text-xs text-slate-500">{nodes.length} nodes &middot; {edges.length} connections</p>
